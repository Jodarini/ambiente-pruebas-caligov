$(document).ready(function(){$("img").each(function(){$(this).attr("title",$(this).attr("alt"))}),$("[data-toggle=popover]").length>0&&(979>=$(window).width()?$(document).find("[data-toggle=popover]").each(function(){(void 0===$(this).data("placement")||"left"===$(this).data("placement")||"right"===$(this).data("placement"))&&$(this).popover({placement:"bottom"})}):$("[data-toggle=popover]").popover()),$("#navbar").addClass("navbar-fixed-top"),$(window).scroll(function(){$(this).scrollTop()>103?$("#navbar").addClass("nxMenuFixed"):$("#navbar").removeClass("nxMenuFixed")})});
